<?php /* Smarty version 2.6.13, created on 2015-07-13 18:01:27
         compiled from mercato.html */ ?>
<!DOCTYPE HTML>
<!--
...
<html>
	<head>
		<title>FantaConTe Mercato</title>
		<meta charset="utf-8" />
	...
	<body>
		...
		<!-- Page Wrapper -->
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header">
						<h1><a href="index.html"><h2><font color=green>Fanta</font><font color=white>Con</font><font color=red>Te</font></h2></a></h1>
						<nav id="nav">
							<ul>
								<li class="special">
